...
public class website_rhc {
    private static Instance[] instances = initializeInstances();
    private static Instance[] train_set = Arrays.copyOfRange(instances, 0, 406);
    private static Instance[] test_set = Arrays.copyOfRange(instances, 406, 1353);
    ...
    public static void main(String[] args) {
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int i = 0; i < oa.length; i++) {
                ...
                write_output_to_file("Optimization_Results", "website_results_rhc.csv", final_result, true);
    ...
    private static Instance[] initializeInstances() {
        ...
        double[][][] attributes = new double[1353][][];

        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/website.csv")));
            ...
            for(int i = 0; i < attributes.length; i++) {
                ...
                attributes[i][0] = new double[9]; // 16 attributes
